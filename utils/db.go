...
func ConnectDB() *gorm.DB {
	...
	dbURI := fmt.Sprintf("host=%s user=%s port=%s dbname=%s sslmode=disable password=%s", databaseHost, username, databasePort, databaseName, password)
